...
export default class vehicleresult extends Component {
    listFilmsAppeared() {
        let index = 0;
        ...
        return (
            <div>
                ...
                <div className={styles.details}>
                    ...
                    <p>cost_in_credits : {this.props.content.cost_in_credits}</p>
                    ...
                    <p>consumables : {this.props.content.consumables}</p>
                    <p>vehicle class : {this.props.content.vehicle_class}</p>
                </div>
